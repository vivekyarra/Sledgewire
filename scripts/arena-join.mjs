...
console.log(JSON.stringify({joined:true,room_id:room,last_sequence:joined.lastSequence,token_file:tokenFile,note:'seat token stored owner-only and intentionally not printed'},null,2));
