...
- [ ] At least 12 hostile cases exercised in release environment and at least 3 real MCP implementations tested.
- [ ] SharedOS event visibility integration confirmed with a real Sledgewire trace if entering SharedOS track.
- [ ] 60-minute no-human autonomous rehearsal passes.
- [ ] Smoke p95 <25s on real targets; all paid calls finish under event cap.
...
- [ ] Independent verifier reruns acceptance tests after patch.
