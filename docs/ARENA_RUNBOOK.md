...
- Confirm `GET /health`, `/.well-known/agent.json`, `/catalog.json`, `/public-key`, and MCP initialize/list/call externally.
...
- Freeze code. Do not improvise permissions during the autonomous rounds.
